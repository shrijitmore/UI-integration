...
const FaiInspection = () => {
  ...
  const steps = [
    ...
    { step: "Step 2", text: "Select Production Order", color: "#ebf9ffff" },
    ...
    { step: "Step 6", text: "Add Operations Readings", color: "#ffece0ff" },
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const poRes = await dispatch(FAIpoOrderList()).unwrap();
    ...
    <Box>
      ...
      {activeView != null && (
        <ParameterWiseTable
          ...
          setIsUpdated={setIsUpdated} // now it's validgi 
        />
      )}
    </Box>
  );

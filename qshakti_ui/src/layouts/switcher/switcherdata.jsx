...
export const LocalBackup = () => {
  ...
  (localStorage.spariclightmenu) && Lightmenu();
  (localStorage.spariccolormenu) && Colormenu();
  (localStorage.sparicdarkmenu) && Darkmenu();
  (localStorage.spariclightheader) && Lightheader();
  (localStorage.spariccolorheader) && Colorheader();
  (localStorage.sparicdarkheader) && Darkheader();
